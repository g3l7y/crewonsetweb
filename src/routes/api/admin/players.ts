      ...
      GET: async ({ request }) => {
        ...
        try {
            ...
            return Response.json({
              ...
              data: {
                profile: {
                  ...
                  avatarUrl: profile?.AvatarUrl || '/assets/avatar_default.jpg',
                  role: 'cameraman',
                  crewId: 'CREW-001',
                  bio: '',
          ...
          const players: PlayerProfile[] = result.data.Leaderboard.map((entry: any) => ({
            ...
            username: entry.DisplayName?.toLowerCase().replace(/\s+/g, '_') || `player_${entry.Position + 1}`,
            email: '',
            avatarUrl: '/assets/avatar_default.jpg',
            role: 'cameraman',
            crewId: 'CREW-001',
            bio: '',
